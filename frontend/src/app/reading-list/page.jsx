...
export default function ReadingListPage() {
  ...
  const loadItems = () => {
    setItems(getUserWatchlist('BOOK'));
  };
  ...
  return (
    <div className="min-h-[calc(100vh-52px)] bg-page text-ink pb-24 selection:bg-ember/30 selection:text-ink relative overflow-hidden">
      {/* Ambient glow */}
      <div className="fixed top-12 left-1/4 w-96 h-96 rounded-full bg-radial from-gold/[0.05] to-transparent blur-3xl pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">

        {/* ── Page Header ── */}
        <div className="pt-10 pb-6 border-b border-border mb-8">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-gold mb-2">
            LIBRARY
          </p>
        ...
        {items.length === 0 ? (
          <div className="py-24 text-center">
            ...
            <p className="text-xs text-ink-muted mb-6">
              Explore the library and add books you wish to read.
            </p>
            <Link
              href="/books"
